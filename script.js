...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateField(field) {
        ...
        const fieldName = field.name || type;
        ...
        if (field.hasAttribute('pattern') && value !== '') {
            ...
            if (!pattern.test(value)) {
                const message = field.getAttribute('data-error') || 'Invalid format';
    ...
    function handleFormSubmit(e) {
        ...
        if (isValid) {
            ...
            if (form.getAttribute('data-reset') !== 'false') {
                form.reset();
                fields.forEach(field => field.classList.remove('valid'));
            }

            const submitEvent = new CustomEvent('form:success', {
                detail: { form: form }
            });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '965099ed-2426-40c9-b5c0-0182c73af064',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '965099ed-2426-40c9-b5c0-0182c73af064';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '965099ed-2426-40c9-b5c0-0182c73af064';
